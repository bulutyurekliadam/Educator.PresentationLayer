...
namespace Educator.PresentationLayer.Controllers
{
    public class StatisticController : Controller
    {
        public IActionResult Index()
        {
            ...
            ViewBag.getAlgoritmaProgramlamaCoursePrice = context.Courses.Where(x => x.Title == "Algoritma ve Programlama").Select(y => y.Price).FirstOrDefault();
            ...
            ViewBag.getTitleByCourseID6 = context.Courses.Where(x => x.CategoryID == 6).Select(y => y.Title).FirstOrDefault();
